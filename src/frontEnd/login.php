...
?>
    ...
    <form class = "conteudo-bloco-form" method = "POST" action = "../backEnd/functionLogin.php" >
        ...
        <div class="form-area-input">
            ...
            <input type = "email" name = "inputEmail" required placeholder = "Digite aqui seu  email:" id = "input-email">
            <label for = "inputSenha">Senha:</label>
            <input type = "password" name = "inputSenha" required placeholder = "Digite aqui seu  senha:" id = "input-senha">
